  ...
  <html lang="en">
    ...
    <div class="empty-4-3" style="font-family: 'Poppins', sans-serif;">    
        <div class="mx-auto d-flex align-items-center justify-content-center flex-column">
            <img class="img" src="assets/img/ihr_qr_code_ohne_logo.jpg" alt="">                       
            <div class="text-center w-100">
                <h1 class="title-text">
                    Kontak Kami
                </h1>
                <p class="caption-text">
                    Silahkan scan barcode diatas, atau<br class="d-sm-block d-none"> klik tombol di bawah ini jika Anda ingin kembali.
                </p>
                <div class="d-flex justify-content-center">
                    <a href="index.php"><button class="btn btn-set d-inline-flex text-white">
                        Home
                    </button></a>
                </div>
            </div>
